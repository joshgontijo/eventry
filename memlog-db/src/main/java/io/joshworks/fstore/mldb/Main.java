...
//        System.out.println("READ_KEY_ORDER: " + (System.currentTimeMillis() - start) + "ms");
        ...
        Store<String, User> store = Store.create(new File("memStore"), User.userSerializer(), User::getId);
        store.put(new User("id-1", "John", 10));
        store.put(new User("id-2", "Billy", 20));
        store.put(new User("id-3", "Josh", 30));
        ...
        store = Store.open(new File("memStore"), User.userSerializer(), User::getId);
