...
//
//public class CompressedLogSegment<T> implements Log<T> {
//
...
//
//    private static final Logger logger = LoggerFactory.getLogger(CompressedLogSegment.class);
//
//
//    public static <T> CompressedLogSegment<T> create(Storage storage, Serializer<T> serializer) {
//       return new CompressedLogSegment<>(storage, serializer);
//    }
//
//    public static <T> CompressedLogSegment<T> open(Storage storage, Serializer<T> serializer, long position) {
//        return open(storage, serializer, position, false);
//    }
//
//    public static <T> CompressedLogSegment<T> open(Storage storage, Serializer<T> serializer, long position, boolean checkIntegrity) {
//        CompressedLogSegment<T> appender = null;
//        try {
//
//            appender = new CompressedLogSegment<>(storage, serializer);
//            if (checkIntegrity) {
...
//    }
//
//    private CompressedLogSegment(Storage storage, Serializer<T> serializer) {
