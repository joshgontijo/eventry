...
public class MurmurHash3  {
     ...
     */
    public static long[] MurmurHash3_x64_128(final byte[] key, final long seed) {
     ...
     */
    public static long MurmurHash3_x64_64(final byte[] key, final long seed) {
     ...
     */
    public static int MurmurHash3_x64_32(final byte[] key, final long seed) {
     ...
     * @return 128 bit hashed key, in an array containing two longs
     */
    public static long[] MurmurHash3_x64_128(final long[] key, final long seed) {
        State state = new State();
